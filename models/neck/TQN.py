...
class TQN(nn.Module):
    def __init__(self,d_model, num_queries, query_var=1, pe="no", H=4, N=2, feature_dim=1024, max_len=136, dropout=0.5):
        ...
        decoder_layer = TransformerDecoderLayer(self.d_model, H, self.d_model,
                                        dropout, 'relu',normalize_before=True)
